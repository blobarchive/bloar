...
func TestP2PMetricLabelsStayClosed(t *testing.T) {
	...
	body := scrape(t, m)
	for _, unbounded := range []string{"peer-id-as-direction", "198.51.100.1", "12D3KooWunboundedPeerID", "untrusted-operation", "untrusted-outcome", "bafy-untrusted-kind", "12D3Koo-untrusted-reason", "bafy-untrusted-stage"} {
