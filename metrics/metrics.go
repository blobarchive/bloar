...
func New() *Metrics {
	...
	m.indexArchiveAvailable = gauge("index_archive_available",
		"1 when the indexer's most recent archive availability check received an authoritative HTTP response, "+
			"0 after transport failure, malformed/truncated success, or HTTP 5xx exhausted the bounded request retries. "+
